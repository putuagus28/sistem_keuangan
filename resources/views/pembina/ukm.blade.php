                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex flex-row align-items-center">
                            <a href="{{ route('pembina') }}" class="btn btn-dark">Kembali</a>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="" id="modalForm">
                    @csrf
                    <input type="hidden" name="users_global" id="users_global" value="{{ $id_pem }}">
